...
test_examples = pickle.load(open(os.getcwd()+'/processed_training/sws_train_54k_bigram.pkl', 'r'))
...
ConfMat_path = os.getcwd()+'/test_results/sws_m2w_54k_ConfMat_train.csv'
##############################################################################
# Code
##############################################################################
...
print "The training accuracy from this classifier is %.3f" % accuracy
